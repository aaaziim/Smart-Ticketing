...
PhoneNumber.addEventListener('keyup', function () {
    const inputValue = PhoneNumber.value;  // Get the string value of the input
    const modalBtn = document.getElementById('modal-btn');
    if (inputValue.length !== 0) {
        modalBtn.removeAttribute('disabled');  // Enable the button
    } else {
        modalBtn.setAttribute('disabled', 'true');  // Disable the button
    }
});
